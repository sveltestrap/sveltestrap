...
# Breadcrumbs <small class="bootstrap-docs">[Bootstrap Badges](https://getbootstrap.com/docs/5.3/components/breadcrumb/)</small>

The `<Breadcrumb>` component is used to provide visual cues or supplementary information for things like badging, counts, and more.
