...
⚠️ **Note:** For Svelte 3.x, please use [Sveltestrap 5.x](https://bestguy.github.io/sveltestrap) documentation and [NPM package](https://www.npmjs.com/package/sveltestrap).
