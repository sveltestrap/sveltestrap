...
# Buttons <small class="bootstrap-docs">[Bootstrap Buttons](https://getbootstrap.com/docs/5.3/components/buttons/)</small>
...
<Source dark language="jsx" code={`
<script lang="ts">
  import { Button, ButtonToolbar } from '@sveltestrap/sveltestrap';
</script>
